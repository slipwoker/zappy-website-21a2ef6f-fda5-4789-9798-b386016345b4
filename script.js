document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearFieldError(field) {
      ...
      const sibling = field.parentNode.querySelector('.form-error-message');
  ...
  const OBSERVED_SELECTOR = '.fade-in, .slide-up, .slide-left, .slide-right, [data-animate]';
  ...
  staggerGroups.forEach(function (group) {
    ...
    const baseDelay = parseInt(group.getAttribute('data-stagger') || '100', 10);

    Array.from(children).forEach(function (child, index) {
      if (!child.hasAttribute('data-delay')) {
        child.setAttribute('data-delay', index * baseDelay);
      }
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "פטניק uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '21a2ef6f-fda5-4789-9798-b386016345b4',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '21a2ef6f-fda5-4789-9798-b386016345b4';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '21a2ef6f-fda5-4789-9798-b386016345b4';
